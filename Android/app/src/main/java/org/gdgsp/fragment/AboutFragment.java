...
public class AboutFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, 	Bundle savedInstanceState) {
		...
		String about_text = "<h3>GDG</h3>" +
			...
			"<p>Desenvolvi o aplicativo do GDG-SP por sentir falta de notificações de novos eventos em tempo real no aplicativo oficial do meetup, e para facilitar como os sorteios são feitos. Desenvolvi várias versões desse aplicativo, todas em código aberto para ajudar pessoas que querem aprender a desenvolver para diversas plataformas, sendo elas nativamente para Android e Universal Windows Platform, e em Xamarin para iOS e Windows Phone, você pode ver o código exato dos aplicativos e o backend em PHP no meu <a href=\"http://github.com/alefesouza/gdg-sp\">GitHub</a>, procurei deixar o código para ser facilmente adaptado para outros meetups, bastando editar apenas um arquivo em cada plataforma e mudar os ícones.</p>" +

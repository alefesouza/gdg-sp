...
mysqli_query($dbi, "CREATE TABLE IF NOT EXISTS meetups (id int auto_increment primary key, meetupid varchar(100), meetupapi_client varchar(50), meetupapi_secret varchar(50), onesignal_appid varchar(50), onesignal_restkey varchar(50), wns_sid varchar(100), wns_clientsecret varchar(50), cover_image text, last_event int)") or die("ERROR: ".mysqli_error($dbi));
